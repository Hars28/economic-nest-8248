  ...
  return (
    ...
    >
      <Image
        ...
        cursor="pointer"
        w={["20%", "20%", "15%", "15%"]}
        src="/shopeeasy-logo.png"
        alt=""
      />
      <Flex
        w={{ sm: "500px", sm: "500px", md: "700px", lg: "900px" }}
        direction="column"
        border="3px orange"
      >
        <HStack
        ...
        >
          {auth ? (
            <>
              <Text>{session.data.user.name.trim().split(" ")[0]}</Text>
          ...
          <Button
            ...
            onClick={() =>
              router.push(
                "https://luxe.ajio.com/?_ga=2.146994423.1331547409.1667928574-1338200682.1667928574"
              )
            }
            color="white"
          >
        ...
        <HStack
          ...
          justify="flex-end"
        >
          <Button variant="ghost" onClick={() => router.replace("/mens")}>
            MEN
          </Button>
          <Button variant="ghost" onClick={() => router.replace("/womens")}>
            WOMEN
          </Button>
          <Button variant="ghost" onClick={() => router.replace("/kids")}>
            KIDS
          </Button>
          <Button variant="ghost" onClick={() => router.replace("/indie")}>
            INDIE
          </Button>
